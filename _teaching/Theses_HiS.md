...
During my stay at the University of Skövde I both supervised and examined bachelor theses. Here is a compiled list of the works I have been involved in.

## Supervisor

### 2020
**Title:** Steering techniques in racing games : A comparison of steering techniques in racing games for creating human AI-behavior
...
**Title:** Recreate human behaviour with artificial intelligence in 2D top-down wave shooter game
...
### 2021
**Title:** Application of a 2D dungeon algorithm in 3D space : How well does TinyKeep’s dungeon algorithm perform in three dimensions?
...
**Title:** The impact of different learning algoritms when learning a racing game: A comparison between proximal policy optimization (PPO) and soft actor-critic (SAC) in a racing game
...
**Title:** PCG - Procedural Cave Generation : A comparative study of Cellular Automata, Random Walk and Perlin Noise
...
**Title:** Procedural generation of race tracks using Voronoi diagrams : Procedurally generated Formula 1 circuits using modified Voronoi diagrams and self-avoiding random walk
...
**Title:** Motion sickness in virtual reality : How big of an impact the motion system has on it
...
### 2022
**Title:** The apparent intelligence of videogame agents and it’s correlation to predictability and difficulty : The player’s percieved view
...
**Title:** How can a player enjoyment model be used in the design of a mobile puzzle game for Android-phones?
...
**Title:** Line art by 3D rendering : How inked line art may be emulated in an interactive, three-dimensional scene
...
**Title:** Procedural cavegeneration in computergames : A comparison between algorithms
...
### 2023
**Title:** An investigation of Artificial Intelligence in games : AI and its connection to game feel in the game Alien: Isolation
...
**Title:** Trends in dialogue tools for game development: A meta review
...
**Title:** Common problems and solutions for online games
...
### 2024
**Title:** Opportunities for improvement in Dijkstra’s graph search algorithm : A comparative analysis of pathfinding algorithms for a grid-based world
...
**Title:** Scrum in game development: A Mapping of Scrum Methodology
...
### 2022
**Title:** Predicting a player’s future actions : An evaluation of an Elman network’s ability to predict a player’s future actions
...
**Title:** Spatial performance profiling in games : Localisation of performance problems in game levels
...
### 2023
**Title:** Evaluation of an analysis tool for dependency identification in source code
...
**Title:** Visual programming and shaderperformance: A comparison between shaders made in Unreal Material and HLSL
